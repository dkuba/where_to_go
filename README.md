...
### Добавление новых даных

Информация о местах может быть загружена через админку или с помощью утилиты load_place

```sh
python manage.py load_place [url]
```

#### Формат данных для загрузки из внешнего источника
